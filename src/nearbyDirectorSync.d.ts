...
export function takeoverNearbyDirector(sessionCode: string): Promise<Record<string, unknown>>;
...
export function refreshDirectorBrowse(): Promise<Record<string, unknown> | null>;
