...
const IOS_BUNDLE_ID = "com.cazares.alverniareader";
const ANDROID_PACKAGE = "com.cazares.alverniareader";
...
const EMBEDDED_ONLY_UPDATES = true;
...
module.exports = ({ config }) => {
  ...
  const otaChannel =
    ...
    DEFAULT_OTA_CHANNEL;
  const otaEnabled = EMBEDDED_ONLY_UPDATES
    ? false
    : parseBooleanEnv(process.env.EXPO_PUBLIC_OTA_ENABLED, true);
  const otaAutoCheckOnForeground = EMBEDDED_ONLY_UPDATES
    ? false
    : parseBooleanEnv(process.env.EXPO_PUBLIC_OTA_AUTO_CHECK, true);
  ...
  return {
    ...
    updates: {
      ...
      checkAutomatically: updatesEnabled
        ? existingUpdates.checkAutomatically || "ON_LOAD"
        : "NEVER",
    ...
    ios: {
      ...
      infoPlist: {
        ...
        NSPhotoLibraryAddUsageDescription:
          ...
          "Alvernia Reader can save generated files to your Photos library if you choose.",
        NSPhotoLibraryUsageDescription:
          existingInfoPlist.NSPhotoLibraryUsageDescription ||
          "Allow Alvernia Reader to access your Photos library if needed.",
        NSUserNotificationsUsageDescription:
          existingInfoPlist.NSUserNotificationsUsageDescription ||
          "Alvernia Reader can send optional notifications when background processing finishes.",
        ITSAppUsesNonExemptEncryption:
          typeof existingInfoPlist.ITSAppUsesNonExemptEncryption === "boolean"
            ? existingInfoPlist.ITSAppUsesNonExemptEncryption
            : false,
        UIBackgroundModes: currentBackgroundModes.filter((mode) => mode !== "audio"),
      },
    },
    android: {
