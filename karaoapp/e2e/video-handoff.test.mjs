...
test("shouldResetPlaybackOnSourceChange resets non-handoff source swaps", () => {
  assert.equal(
    shouldResetPlaybackOnSourceChange({
      sourceChanged: true,
      previousOutputUrl: "https://cdn.example/old-final.mp4",
      previousIsPreview: false,
      nextOutputUrl: "https://cdn.example/new-final.mp4",
      nextIsPreview: false,
      handoffSeek: 18.4,
    }),
    true
